...
public class ListeningAmountSelectActivity extends BaseActivity implements RefreshListener{
		...
		public void onClick(View v) {
			...
			case R.id.type_select_btn_0: {
				if(UpperLimitHelper.getInstance().getIsUnderLimit(1)){
					Intent intent = new Intent(ListeningAmountSelectActivity.this, mType == Problem.PASSAGE_DICTATION ? DictationActivity.class : ListeningActivity.class);
				...
				MobclickAgent.onEvent(ListeningAmountSelectActivity.this, getUmengKeyByType(), 1);	
			}
				break;
			case R.id.type_select_btn_1: {
				...
				MobclickAgent.onEvent(ListeningAmountSelectActivity.this, getUmengKeyByType(), 2);	
			}
				break;
			case R.id.type_select_btn_2: {
				...
				MobclickAgent.onEvent(ListeningAmountSelectActivity.this, getUmengKeyByType(), 3);	
			}
				break;
			case R.id.type_select_btn_3: {
				...
				MobclickAgent.onEvent(ListeningAmountSelectActivity.this, getUmengKeyByType(), 5);	
			}
				break;
			default:
				break;
		...
		.setPositiveButton("现在购买",
				new DialogInterface.OnClickListener() {
					public void onClick(
							...
							int i) {
						if(mPayUtils == null){
							mPayUtils = new PayUtils(ListeningAmountSelectActivity.this, ListeningAmountSelectActivity.this);
						}
	...
	private String getUmengKeyByType(){
		...
		switch (mType) {
		case Problem.SHORT_CONVERSATIONS:
			result = "action_select_short_conversations_amount";
			break;
		case Problem.LONG_CONVERSATIONS:
			result = "action_select_click_long_conversations_amount";
			break;
		case Problem.SHORT_PASSAGES:
			result = "action_select_short_passages_amount";
			break;
		case Problem.PASSAGE_DICTATION:
			result = "";
			break;
